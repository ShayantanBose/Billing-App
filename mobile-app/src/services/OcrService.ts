...
// ...existing code...
// We cannot use the browser Canvas API in React Native.
// We will rely on Tesseract's internal preprocessing or use a native module if needed.
// For this implementation, we will pass the image URI directly to Tesseract.

export const processImageWithOCR = async (imageUri: string): Promise<string> => {
  try {
    // Tesseract.js in React Native might need a specific adapter or just base64
...
// EXACT COPY OF THE PARSING LOGIC
